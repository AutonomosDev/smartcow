    ...
    <View style={s.root}>
      ...
      <SafeAreaView style={s.safe}>
        ...
        {saveOpen && (
          ...
          >
            <CwModalOpt color="red"   icon={<FileText  size={16} color="#1a1a1a" />} t1="Guardar como PDF"           t2={saving === 'pdf'     ? 'Generando PDF…'       : 'Se descarga local al equipo'}           working={saving === 'pdf'}     onPress={() => startSave('pdf')} />
            ...
            <CwModalOpt color="amber" icon={<Mail      size={16} color="#1a1a1a" />} t1="Enviar por email"             t2={saving === 'email'   ? 'Enviando…'            : 'jp@agropecuaria.cl'}                    working={saving === 'email'}   onPress={() => startSave('email')} />
        ...
        {copyOpen && (
          ...
          >
            ...
            <CwModalOpt color="amber"icon={<Link2     size={16} color="#1a1a1a" />} t1="Copiar link compartible"      t2={copied === 'link'  ? '✓ Copiado'               : 'Acceso solo para equipo smartCow'}       onPress={() => doCopy('link')} />
            <CwModalOpt color="red"  icon={<Table2    size={16} color="#1a1a1a" />} t1="Exportar a Excel / CSV"       t2={copied === 'xlsx'  ? '✓ Generando .xlsx…'      : 'Solo tablas y KPIs del informe'}         onPress={() => doCopy('xlsx')} />

/**
 * app/api/fundo/[id]/kpis/route.ts
 * GET /api/fundo/:id/kpis — mantenido por compatibilidad mobile
 * Redirige lógica a /api/predio/:id/kpis internamente.
 *
...
export async function GET(
  ...
  void session; // sesión validada, no se necesita más aquí
